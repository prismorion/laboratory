                ...
                <section className={styles.section}>
                    <div className={styles.container}>
                        <div className={styles.sectionHeader}>
                            ...
                            <h2 className={styles.blockTitle}>Руководство центра</h2>
                        </div>
                        ...
                        <div className={styles.sectionHeader} style={{ marginTop: '48px' }}>
                            <h2 className={styles.blockTitle}>Заведующие лабораториями</h2>
                        </div>
                        <div className={styles.teamGrid} style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
